  ...
  const getOrderStatusConfig = (
    ...
    if (isGift && !giftClaimed) {
      return {
        ...
        description:
          'Your gift has been purchased and is ready to be redeemed by your loved ones.',
        nextSteps:
          'Share the gift link with your loved one so they can claim their personalized skincare regime.',
      };
    }
      ...
      switch (status) {
        case 'pending':
          return {
            ...
            description:
              'Your gift has been redeemed and the order is awaiting confirmation.',
            nextSteps:
              'We will confirm the order and begin processing within 24 hours.',
          };
        case 'processing':
          return {
            icon: Package,
            ...
            description:
              'The personalized skincare regime is being curated for your recipient.',
            nextSteps:
              'The order will be packed and shipped within 1-2 business days.',
          };
        case 'shipped':
          return {
            icon: Truck,
        ...
        case 'completed':
          return {
            ...
            description:
              'Your gift has been successfully delivered to the recipient!',
            nextSteps:
              'Your gift has brought joy and beautiful skin to your loved one!',
          };
        case 'cancelled':
          return {
            icon: X,
    ...
    switch (status) {
      case 'pending':
        return {
          ...
          nextSteps:
            'We will confirm your order and begin processing within 24 hours.',
        };
      case 'processing':
        return {
          icon: Package,
          ...
          description:
            'Your personalized skincare regime is being curated by our experts.',
          nextSteps:
      ...
      case 'completed':
        return {
          ...
          description:
            'Your Korean skincare regime has been successfully delivered!',
          nextSteps:
            "Enjoy your personalized skincare journey. Don't forget to leave a review!",
        };
      case 'cancelled':
        return {
          icon: X,
    ...
    <div className="min-h-screen bg-gray-50 py-40">
      <div className="container section-padding">
        <div className="max-w-3xl mx-auto">
          ...
          >
            <div
              className={`w-20 h-20 rounded-full flex items-center justify-center shadow-sm mx-auto mb-6 ${
            ...
            <p className="text-lg text-black mb-2">
              {order?.isGift
                ? 'Thank you for your purchase. You can now share the link with your loved one!'
                : order?.status === 'cancelled'
          ...
          {order && (
            ...
            >
              {(() => {
                ...
                return (
                  <div
                    className={`relative overflow-hidden rounded-xl border-2 bg-white border-primary p-6`}
                  >
          ...
          >
            ...
            {order && regime ? (
              <div className="flex flex-col gap-4">
                <div className="flex flex-col gap-4 items-start space-x-4">
                  ...
                  <div className="flex-1">
                    <h3 className="font-semibold text-black">
                      {regime.name} - {regime.stepCount} steps routine
                    </h3>
                ...
                {(!order.isGift || order.giftClaimed) &&
                  order.userDetails?.skincareSteps && (
              ...
              <div className="space-y-4">
                ...
                {(!order.isGift || order.giftClaimed) &&
                  order.userDetails?.skincareSteps &&
                  order.userDetails.skincareSteps.length > 0 && (
                    <div className="mt-6 pt-6 border-t border-gray-100">
                      <h3 className="font-semibold text-black mb-3">
                        Your Personalized Regime Steps
                      </h3>
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-black text-sm">
                      You&apos;ve successfully purchased a personalized skincare
                      regime as a gift!
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-black text-sm">
                      Use the share options above to send the gift link to your
                      recipient. They&apos;ll need to complete their skincare
                      profile and provide their shipping address.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-sm">
                      Once your recipient claims the gift, the order will be
                      processed and shipped to their address.
                    </p>
                  </div>
                </div>
              </div>
                          ...
                          <div className="flex items-start space-x-3">
                            ...
                            <div>
                              ...
                              <p className="text-black text-xs">
                                If you were charged, your refund will be
